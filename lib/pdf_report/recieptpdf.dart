...
class ReciPDFscreen extends StatefulWidget {
  final File pdfFile;
  const ReciPDFscreen(this.pdfFile, {super.key});

  @override
  State<ReciPDFscreen> createState() => _ReciPDFscreenState();
}

class _ReciPDFscreenState extends State<ReciPDFscreen> {
  int totalPages = 0;
  int currentPage = 0;
 ...
 Future<void> _downloadPDF() async {
  try {
    ...
    final path = '${downloadsDir.path}/recipt_report.pdf';
